...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "fhaddcom_finance_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "finance_management_audit", "varname" => "fhaddcom_finance_at_localhost__finance_management_audit", "altvarname" => "finance_management_audit", "connId" => "fhaddcom_finance_at_localhost", "schema" => "", "connName" => "finance at localhost");
			$dalTables[$conn->connId][] = array("name" => "finance_management_locking", "varname" => "fhaddcom_finance_at_localhost__finance_management_locking", "altvarname" => "finance_management_locking", "connId" => "fhaddcom_finance_at_localhost", "schema" => "", "connName" => "finance at localhost");
			$dalTables[$conn->connId][] = array("name" => "tbl_budgets", "varname" => "fhaddcom_finance_at_localhost__tbl_budgets", "altvarname" => "tbl_budgets", "connId" => "fhaddcom_finance_at_localhost", "schema" => "", "connName" => "finance at localhost");
			$dalTables[$conn->connId][] = array("name" => "tbl_categories", "varname" => "fhaddcom_finance_at_localhost__tbl_categories", "altvarname" => "tbl_categories", "connId" => "fhaddcom_finance_at_localhost", "schema" => "", "connName" => "finance at localhost");
			$dalTables[$conn->connId][] = array("name" => "tbl_expenses", "varname" => "fhaddcom_finance_at_localhost__tbl_expenses", "altvarname" => "tbl_expenses", "connId" => "fhaddcom_finance_at_localhost", "schema" => "", "connName" => "finance at localhost");
			$dalTables[$conn->connId][] = array("name" => "tbl_income", "varname" => "fhaddcom_finance_at_localhost__tbl_income", "altvarname" => "tbl_income", "connId" => "fhaddcom_finance_at_localhost", "schema" => "", "connName" => "finance at localhost");
			$dalTables[$conn->connId][] = array("name" => "tbl_users", "varname" => "fhaddcom_finance_at_localhost__tbl_users", "altvarname" => "tbl_users", "connId" => "fhaddcom_finance_at_localhost", "schema" => "", "connName" => "finance at localhost");
		}
	}
