...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "fhaddcom_finance_at_localhost";
		}
		return $connId;
	}
	...
	*/
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("tbl_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "tbl_categories" ] = array( "url" => "tbl_categories", "type" => 0 );
	$projectEntitiesReverse[ "tbl_categories" ] = "tbl_categories";
	$projectEntities[ "tbl_budgets" ] = array( "url" => "tbl_budgets", "type" => 0 );
	$projectEntitiesReverse[ "tbl_budgets" ] = "tbl_budgets";
	$projectEntities[ "tbl_expenses" ] = array( "url" => "tbl_expenses", "type" => 0 );
	$projectEntitiesReverse[ "tbl_expenses" ] = "tbl_expenses";
	$projectEntities[ "tbl_income" ] = array( "url" => "tbl_income", "type" => 0 );
	$projectEntitiesReverse[ "tbl_income" ] = "tbl_income";
	$projectEntities[ "tbl_users" ] = array( "url" => "tbl_users", "type" => 0 );
	$projectEntitiesReverse[ "tbl_users" ] = "tbl_users";
}
