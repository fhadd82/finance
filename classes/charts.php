...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("tbl_categories" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_budgets" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_expenses" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_income" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_users" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
