...
function checkTableName($shortTName )
{
	...
	if ("tbl_categories" == $shortTName )
		return true;
	if ("tbl_budgets" == $shortTName )
		return true;
	if ("tbl_expenses" == $shortTName )
		return true;
	if ("tbl_income" == $shortTName )
		return true;
	if ("tbl_users" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_categories");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_budgets");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_expenses");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_income");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tbl_users");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
//	default permissions
	...
	if( $table=="tbl_budgets" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tbl_expenses" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
