...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "fhaddcom_finance_at_localhost" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["tbl_categories"] = "fhaddcom_finance_at_localhost";
		$connectionsIds["tbl_budgets"] = "fhaddcom_finance_at_localhost";
		$connectionsIds["tbl_expenses"] = "fhaddcom_finance_at_localhost";
		$connectionsIds["tbl_income"] = "fhaddcom_finance_at_localhost";
		$connectionsIds["tbl_users"] = "fhaddcom_finance_at_localhost";
