...
* **🔐 High Security (Fintech-Grade):**
    ...
    * **Sign in with Google** (Google OAuth) integration support. (Only Full Version)
...
* **💸 Intuitive Transaction Management:**
    ...
    * Special tagging for **Tax Relief** for future eFiling reference.
...
---
https://www.fhadd.com/finance/ <---- demo. Please Register First.
## 📸 Screenshots
...
* **Security:** CryptoJS (AES-128), Google OAuth 2.0 (Only with Full Version)
...
Please e-mail admin[@]fhadd.com for more infor about full version and English Version.
...
* **🔐 Keselamatan Tinggi (Fintech-Grade):**
    ...
    * Sokongan integrasi **Log Masuk dengan Google** (Google OAuth). (Tersedia untuk Full Version)
...
* **💸 Pengurusan Transaksi Intuitif:**
    ...
    * Fungsi penandaan khas untuk **Pelepasan Cukai** untuk rujukan akan datang ketika proses eFiling.
...
* **Keselamatan:** CryptoJS (AES-128), Google OAuth 2.0 (Full Version)
